...
public class WeatherApp {
    ...
    public static JSONObject getWeatherData(String lotacionName) {
        ...
        try {
            ...
            // get humidity
            JSONArray relativeHumidity = (JSONArray) hourly.get("relative");
            long humidity = (long) relativeHumidity.get(index);

            // get windspeed
            JSONArray windspeendDate = (JSONArray) hourly.get("windspeed_10m");
            double windspeed = (double) windspeendDate.get(index);
